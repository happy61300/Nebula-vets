...
export const preData = [
  { iname: "Preventive Care" },
  { iname: "Sick Patient Care" },
  { iname: "Surgery" },
  { iname: "Additional Services" },
];
export const precareData = [
  {
...
export const sickData = [
  ...
  },
  {
    ...
    dis: "Nebula vets offers a fast telemedicine service, to help your pet without leaving the home",
    btnName: "LEARN MORE",
  },
  {
    head: "Diagnostics",
